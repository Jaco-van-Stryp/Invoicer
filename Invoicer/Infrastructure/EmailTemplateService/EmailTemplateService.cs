...
namespace Invoicer.Infrastructure.EmailTemplateService
{
    public class EmailTemplateService : IEmailTemplateService
    {
        ...
        private readonly string _resourcePrefix =
            "Invoicer.Infrastructure.EmailTemplateService.Templates";
        private readonly ConcurrentDictionary<string, string> _cache = new();

        // Placeholders whose values contain pre-rendered HTML and must not be encoded
        private static readonly HashSet<string> RawHtmlPlaceholders = new(
                ...
                key =>
                {
                    ...
                    using var stream =
                        ...
                        ?? throw new InvalidOperationException(
                            $"Email template '{key}' not found as embedded resource '{resourceName}'."
                        );
        ...
        )
        {
            ...
            {
                var encoded = RawHtmlPlaceholders.Contains(key)
                    ? value
